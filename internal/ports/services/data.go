...
var ports = map[int]Info{
	...
	515: {Name: "LPD/Printer", Description: "Line Printer Daemon (legacy)"},
	...
	1723:  {Name: "PPTP/VPN", Description: "VPN protocol (legacy)"},
	...
	5173:  {Name: "Vite", Description: "Vite development server"},
	...
	5984:  {Name: "CouchDB/Sync", Description: "CouchDB or sync services"},
	6379:  {Name: "Redis", Description: "Redis Database"},
	6443:  {Name: "Kubernetes", Description: "Kubernetes API Server"},
	7000:  {Name: "Dev-Server", Description: "Common development server port"},
	8000:  {Name: "Dev-Server", Description: "Development server (e.g. Django, Python)"},
	...
	9000:  {Name: "Dev-Server", Description: "Common development server port"},
	...
	4000:  {Name: "Dev-Server", Description: "Development server or Diablo II (game)"},
	...
	// IoT and Smart Home
	1880: {Name: "Node-RED", Description: "Node-RED automation"},
	1900: {Name: "UPnP", Description: "Universal Plug and Play"},
	5683: {Name: "CoAP/IoT", Description: "IoT protocol"},
	8123: {Name: "Home-Assistant", Description: "Home Assistant"},

	// Media and Monitoring
	8006:  {Name: "Proxmox", Description: "Proxmox web interface"},
	8096:  {Name: "Jellyfin", Description: "Jellyfin media server"},
	8200:  {Name: "Vaultwarden", Description: "Vaultwarden password manager"},
